...
<template>
    ...
    <AppLayout>
        ...
        <Dialog
            v-model:visible="autoSummaryVisible"
            modal
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-1">
                                    ...
                                    <span class="text-xs font-semibold" :style="{ color: scoreColor(result.room.score) }">
                                        {{ result.room.score }}%
                                    </span>
                                </div>
                                <p class="text-sm font-medium text-slate-800 mb-1">{{ result.room.name }}</p>
                                <ProgressBar
                                    :value="result.room.score"
                                    :showValue="false"
                                    style="height: 6px"
                                    :pt="{ value: { style: `background:${scoreColor(result.room.score)}` } }"
                                />
                                <ul class="mt-2 space-y-0.5">
                                    <li
                                        v-for="(reason, idx) in result.room.reasons"
                                        :key="idx"
