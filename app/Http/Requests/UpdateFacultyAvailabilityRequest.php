...
class UpdateFacultyAvailabilityRequest extends FormRequest
{
    /**
    ...
    {
        $availability = $this->route('faculty_availability');

        return [
            'day_of_week' => [
                'required',
                Rule::in(['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday']),
                // One record per day, per faculty member — ignore this record itself.
                Rule::unique('faculty_availabilities', 'day_of_week')
                    ->where('faculty_id', $availability->faculty_id)
